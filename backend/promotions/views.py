...
<div class="hero"><div class="container"><h1>🎯 Promotions</h1><form method="get" class="search-box"><input type="text" name="search" placeholder="Search..." value="{escape(search)}"><button type="submit">Search</button></form></div></div>
...
<div class="box"><h1>📤 Submit Proof</h1><h2>{escape(claim.promotion.title)}</h2><p>{escape(claim.promotion.description)}</p>
